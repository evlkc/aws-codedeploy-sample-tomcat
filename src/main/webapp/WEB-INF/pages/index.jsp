...
<head>
    ...
    <title>Bespoke Suits for Pats Dogs! (A sample app for CodeDeploy)</title>
...
<body role="document">
  ...
  <div class="container theme-showcase" role="main">
    ...
    <div class="jumbotron">
      ...
      <p><i>Why can't your Chiefs be classy too?</i></p>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Great for FSA Photos</h3>
          </div>
          <div class="panel-body">
